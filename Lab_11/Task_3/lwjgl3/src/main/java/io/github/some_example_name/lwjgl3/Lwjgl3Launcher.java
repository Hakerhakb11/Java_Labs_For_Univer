...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Lab_11_VISUAL");
        ...
        configuration.setWindowedMode(1980, 1080); // default w640, h480
        //// You can change these files; they are in lwjgl3/src/main/resources/ .
        //// They can also be loaded from the root of assets/ .
        configuration.setWindowIcon("libgdx128.png", "libgdx64.png", "libgdx32.png", "libgdx16.png");

        //// This could improve compatibility with Windows machines with buggy OpenGL
        //// drivers, Macs
        ...
        //// function.
        //// You would need to add this line to lwjgl3/build.gradle , below the
        //// dependency on `gdx-backend-lwjgl3`:
        //// implementation "com.badlogicgames.gdx:gdx-lwjgl3-angle:$gdxVersion"
        //// You can choose to add the following line and the mentioned dependency if
        //// you want; they
        //// are not intended for games that use GL30 (which is compatibility with
        //// OpenGL ES 3.0).
        //// Know that it might not work well in some cases.
        // configuration.setOpenGLEmulation(Lwjgl3ApplicationConfiguration.GLEmulation.ANGLE_GLES20,
        // 0, 0);
